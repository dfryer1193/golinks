...
var _ LinkMap = (*CachingLinkMap)(nil)

// CachingLinkMap houses the map of redirects, and keeps track of the backing file for
// maintaining the map across restarts. It also handles thread safety.
type CachingLinkMap struct {
	store   storage.Storage
	m       map[string]string
	mapLock *sync.RWMutex
}

// NewCachingLinkMap generates a new LinkMap object, with the requested config if it
...
// an error.
func NewCachingLinkMap(persistType storage.StorageType, requestedConfig string) *CachingLinkMap {
...
func (l *CachingLinkMap) handleReload() {
...
func (l *CachingLinkMap) Get(key string) (string, bool) {
	l.mapLock.RLock()
...
func (l *CachingLinkMap) GetAll() map[string]string {
	l.mapLock.RLock()
	defer l.mapLock.RUnlock()
...
func (l *CachingLinkMap) GetAllKeys() []string {
	l.mapLock.RLock()
	defer l.mapLock.RUnlock()
...
func (l *CachingLinkMap) GetFiltered(keys []string) map[string]string {
...
// map, this is a no-op
func (l *CachingLinkMap) Delete(key string) error {
...
func (l *CachingLinkMap) ReplaceAll(mapReader io.Reader) error {
